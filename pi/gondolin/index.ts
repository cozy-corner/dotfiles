...
function sanitizeEnv(env: NodeJS.ProcessEnv | undefined): Record<string, string> | undefined {
	...
	// パターン: *_API_KEY, *_TOKEN, *_SECRET, *_KEY, *_PASSWORD, *_CREDENTIALS など
	const secretPattern = /(API_KEY|ACCESS_KEY|SECRET|TOKEN|PASSWORD|CREDENTIALS|PRIVATE_KEY|AUTH|OAUTH)$/i;
