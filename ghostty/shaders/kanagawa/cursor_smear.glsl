...
// Kanagawa Wave oniViolet (#957fb8) — muted, on-theme, not flashy
const vec4 TRAIL_COLOR = vec4(0.584, 0.498, 0.722, 1.0);
const float DURATION = 0.4; // slightly shorter tail = more restrained
